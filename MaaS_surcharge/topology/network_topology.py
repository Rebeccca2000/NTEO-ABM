...
class SydneyNetworkTopology:
    ...
    def _create_comprehensive_sydney_zones(self):
        ...
        sydney_nodes = [
            ...
            # Western Sydney - T1 Western Line
            NetworkNode("REDFERN", NodeType.TRANSPORT_HUB, (48, 38), 0.3, 0.4,
                       [TransportMode.TRAIN], "Redfern"),
            NetworkNode("STRATHFIELD", NodeType.TRANSPORT_HUB, (40, 35), 0.3, 0.3,
                       [TransportMode.TRAIN, TransportMode.BUS], "Strathfield"),
            NetworkNode("HOMEBUSH", NodeType.LOCAL_STATION, (38, 33), 0.4, 0.2,
                       [TransportMode.TRAIN], "Homebush"),
            NetworkNode("LIDCOMBE", NodeType.LOCAL_STATION, (36, 31), 0.5, 0.2,
                       [TransportMode.TRAIN], "Lidcombe"),
            NetworkNode("PARRAMATTA", NodeType.MAJOR_HUB, (25, 30), 0.4, 0.6,
                       [TransportMode.TRAIN, TransportMode.BUS], "Parramatta"),
            NetworkNode("WESTMEAD", NodeType.LOCAL_STATION, (23, 28), 0.3, 0.3,
                       [TransportMode.TRAIN], "Westmead"),
            NetworkNode("BLACKTOWN", NodeType.TRANSPORT_HUB, (15, 25), 0.5, 0.3,
                       [TransportMode.TRAIN, TransportMode.BUS], "Blacktown"),
            NetworkNode("PENRITH", NodeType.TRANSPORT_HUB, (8, 22), 0.6, 0.2,
                       [TransportMode.TRAIN, TransportMode.BUS], "Penrith"),
            
            # T2 Inner West Line
            NetworkNode("NEWTOWN", NodeType.LOCAL_STATION, (45, 35), 0.4, 0.3,
                       [TransportMode.TRAIN], "Newtown"),
            NetworkNode("SUMMER_HILL", NodeType.LOCAL_STATION, (42, 33), 0.4, 0.2,
                       [TransportMode.TRAIN], "Summer Hill"),
            NetworkNode("ASHFIELD", NodeType.LOCAL_STATION, (40, 32), 0.4, 0.3,
                       [TransportMode.TRAIN, TransportMode.BUS], "Ashfield"),
